...
class StirlingMediaInfo(StirlingClass):
    ...
    video_streams: List[StirlingStreamVideo] = field(default_factory=list)
    audio_streams: List[StirlingStreamAudio] = field(default_factory=list)
    text_streams: List[StirlingStreamText] = field(default_factory=list)
